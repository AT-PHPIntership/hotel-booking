    ...
    <section class="standard-slider room-slider">
      <div class="col-sm-12 col-md-8">
        <div id="owl-standard" class="owl-carousel">
          <div class="item"> <a href="{{ asset('frontend/images/rooms/slider/750x481.gif')}}" data-rel="prettyPhoto[gallery1]"><img src="images/rooms/slider/750x481.gif" alt="Image 2" class="img-responsive"></a> </div>
