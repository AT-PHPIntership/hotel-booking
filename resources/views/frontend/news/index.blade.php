   ...
   <!-- Main content -->
    ...
    @foreach ($categories as $category)
      <section class="rooms">
        <div class="container">
          <div class="row">
            <div class="col-sm-12 cls-header-category">
              <h2  ><a href="{{ route('categories.news', $category->slug) }}"><span class="pull-left cls-title-category">{{ $category->name }}</span></a></h2>
            </div> 
          </div>
          <div class="cls-box-content-news">
